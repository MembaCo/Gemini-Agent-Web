...
const Dashboard = () => {
  ...
  useEffect(() => {
    loadAllData(true); // Initial load

    let interval;
    // Only set up the interval if the settings modal is NOT visible
  ...
  }, [loadAllData, isSettingsModalVisible]); // Dependency array includes isSettingsModalVisible
  ...
  return (
    <div className="bg-gray-900 min-h-screen text-gray-300 font-sans p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        <Header appVersion={settings.APP_VERSION || "3.3.1-hotfix"} onSettingsClick={() => setIsSettingsModalVisible(true)} isLoading={isLoading} />
